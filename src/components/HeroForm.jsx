                    ...
                    <Row className='heroForm'>
                                    <Form >
                                                        <Form.Group className="mb-3" controlId="alias">
                                                                                ...
                                                                                <Form.Control type="text" placeholder={"Hero alias"}></Form.Control>
                                                                                 </Form.Group>
                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                        <Form.Label>Hero Ability: </Form.Label>
                                                                                                                                                                                                                                                            <Form.Control type="text" placeholder="Hero ability" />
                                                                                                                                                                                                                                                                             ...
                                                                                                                                                                                                                                                                             <Form.Select aria-label="Team ID">
                                                                                                                                                                                                                                                                                    <option>Team ID</option>    <option value="1">One</option>    <option value="2">Two</option>    <option value="3">Three</option>  </Form.Select>
